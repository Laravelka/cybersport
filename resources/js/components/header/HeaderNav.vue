								...
								<ul class="mobile-menu__list">
									<li class="mobile-menu__list-item">
										<router-link
												...
												active-class="mobile-menu__list-link_active"
												:to="{ name: 'profile' }"
										>
									...
									<li class="mobile-menu__list-item">
										<a class="mobile-menu__list-link" href="#">
...
<style>
	...
	.mobile-menu {
		...
		transition: all .2s cubic-bezier(1.0, 0.5, 0.8, 1.0);/*cubic-bezier(.155, 1.105, .295, 1.12) 0s;*/
	}
