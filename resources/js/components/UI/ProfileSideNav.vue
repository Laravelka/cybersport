    ...
    <div class="profile-lk">
        ...
        <ul class="profile-lk__list">
            <li class="profile-lk__list-item lk-list">
                <router-link
                        class="profile-lk__list-link lk-link"
                        active-class="profile-lk__list-link_active"
                        :to="{ name: 'profile' }"
                >
            ...
            <li class="profile-lk__list-item lk-list">
                ...
                >
                    ...
                    <span>Рефералка</span></router-link>
            </li>
            <li class="profile-lk__list-item lk-list">
                <router-link
                        class="profile-lk__list-link lk-link"
            ...
            <li class="profile-lk__list-item lk-list">
                ...
                >
                    ...
                    <span>Подписчики <br>и друзья</span></router-link>
            </li>
            <li class="profile-lk__list-item lk-list">
                <a class="profile-lk__list-link lk-link" href="#">
